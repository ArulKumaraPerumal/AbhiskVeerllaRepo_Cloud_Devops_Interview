...
**Deep Dive: Git Clone**
Cloning downloads a complete copy of an existing remote repository onto your computer. This process downloads the files, the complete commit history, and all project branches.
